...
app.post("/analyze-tone", async (req, res) => {
    ...
    try{
        ...
        const prompt = `Analyze the following text and identify the predominant emotion or mood expressed by the user. Choose ONLY ONE emotion from this list: [Stressful, Frustrated, Sad, Angry, Anxious, Confident, Neutral, Excited, Happy, Hopeful, Depressed, Overwhelmed, Calm, Annoyed, Tense].
    ...
    Text to analyze: "${text}"`;
        ...
        res.status(500).json({ error: "Failed to analyze tone", details: error.message });
    }
});
